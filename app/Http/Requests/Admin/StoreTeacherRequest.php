...
class StoreTeacherRequest extends FormRequest
{
    ...
    {
        return [
            // teacher_id is generated by the server and is rejected outright
            // if a request tries to supply one.
    ...
    {
        return [
            'teacher_id.prohibited' => 'The teacher ID is generated automatically and cannot be set.',
