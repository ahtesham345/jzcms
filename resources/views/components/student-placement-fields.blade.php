...
<div
    ...
    x-data="{
        ...
        onStudentTypeChange() {
            ...
            this.setDepartment('madrassa', this.spansBothTracks() ? this.departmentIdFor('madrassa') : '')
            this.setDepartment('school', this.spansBothTracks() ? this.departmentIdFor('school') : '')
        },
        onClassChange(block) {
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="md:col-span-2">
            ...
            <p class="mt-1 text-sm text-gray-500">
                Hifz + School is placed in the madrassa and the school, so it asks for both.
            </p>
            @error('student_type')
        ...
        {{-- Hifz + School: one placement per track. --}}
        @foreach(['madrassa' => 'Madrassa Placement', 'school' => 'School Placement'] as $side => $heading)
            <div class="md:col-span-2" x-show="spansBothTracks()" x-cloak>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            :disabled="! spansBothTracks() || ! {{ $side }}.departmentId"
                            :required="spansBothTracks()"
                    ...
                    <div>
                        ...
                        <select
                            ...
                            :disabled="! spansBothTracks() || ! {{ $side }}.classId || sectionsFor('{{ $side }}').length === 0"
