...
<head>
    ...
    <title>{{ config('jzcms.name', 'JZCMS') }}</title>
    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="flex flex-col items-center justify-center min-h-[calc(100vh-100px)]">
            <div class="text-center">
                <h1 class="text-5xl font-bold text-gray-800 mb-4">{{ config('jzcms.short_name', 'JZCMS') }}</h1>
                <p class="text-xl text-gray-600 mb-8">{{ config('jzcms.name') }}</p>
