<x-layout.admin title="Create Department">
    <x-slot name="header">
        Create Department
    </x-slot>
    ...
    <div class="max-w-2xl">
        ...
        <div class="bg-white rounded-lg shadow-sm">
            ...
            <form action="{{ route('departments.store') }}" method="POST" class="px-6 py-6 space-y-6">
                @csrf
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm text-blue-800">
                        <strong>Note:</strong> All fields marked with <span class="text-red-500">*</span> are required. Department code must be unique.
                    </p>
                </div>
            </div>
        </div>
