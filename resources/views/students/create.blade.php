<x-layout.admin title="Add Student">
    <x-slot name="header">
        Add Student
    </x-slot>
    ...
    <div class="max-w-4xl">
        ...
        <div class="bg-white rounded-lg shadow-sm">
            ...
            <form action="{{ route('students.store') }}" method="POST" class="px-6 py-6 space-y-6" enctype="multipart/form-data">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500">
                                Registration number will be assigned automatically
                            </p>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="Passed" {{ old('student_status') == 'Passed' ? 'selected' : '' }}>Passed</option>
                                <option value="Left" {{ old('student_status') == 'Left' ? 'selected' : '' }}>Left</option>
                            </select>
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            >{{ old('medical_information') }}</textarea>
