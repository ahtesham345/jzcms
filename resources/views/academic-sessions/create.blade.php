<x-layout.admin title="Create Academic Session">
    <x-slot name="header">
        ...
        <div class="bg-white rounded-lg shadow-sm">
            <div class="px-6 py-4 border-b border-gray-200">
                ...
                <p class="text-sm text-gray-600 mt-1">
                    Fill in the details below to create a new academic session.
                </p>
            </div>

            <form action="{{ route('academic-sessions.store') }}" method="POST" class="px-6 py-6 space-y-6">
                @csrf
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm text-blue-800">
                        <strong>Note:</strong> All fields marked with <span class="text-red-500">*</span> are required. End date must be after start date.
                    </p>
                </div>
            </div>
        </div>
