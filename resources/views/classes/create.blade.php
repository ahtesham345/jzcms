<x-layout.admin title="Create Class">
    <x-slot name="header">
        Create Class
    </x-slot>
    ...
    <div class="max-w-2xl">
        ...
        <div class="bg-white rounded-lg shadow-sm">
            ...
            <form action="{{ route('classes.store') }}" method="POST" class="px-6 py-6 space-y-6">
                @csrf
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm text-blue-800">
                        <strong>Note:</strong> All fields marked with <span class="text-red-500">*</span> are required. Class code must be unique.
                    </p>
                </div>
            </div>
        </div>
