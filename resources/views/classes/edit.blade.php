<x-layout.admin title="Edit Class">
    <x-slot name="header">
        Edit Class
    </x-slot>
        ...
        <div class="bg-white rounded-lg shadow-sm">
            <div class="px-6 py-4 border-b border-gray-200">
                ...
                <p class="text-sm text-gray-600 mt-1">
                    Update the details below to modify the class.
                </p>
            </div>

            <form action="{{ route('classes.update', $class->id) }}" method="POST" class="px-6 py-6 space-y-6">
                @csrf
                @method('PUT')
                    ...
                    <div class="space-y-2">
                        <label class="flex items-center">
                            <input 
                                ...
                                name="status" 
                                value="1"
                                {{ old('status', $class->status) == '1' ? 'checked' : '' }}
                        ...
                        <label class="flex items-center">
                            <input 
                                ...
                                name="status" 
                                value="0"
                                {{ old('status', $class->status) == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-2 focus:ring-blue-500"
                            >
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm text-blue-800">
                        <strong>Note:</strong> Fields marked with <span class="text-red-500">*</span> are required. Class code must be unique.
                    </p>
                </div>
            </div>
        </div>
