<x-layout.admin title="Edit Section">
    <x-slot name="header">
        Edit Section
    </x-slot>
        ...
        <div class="bg-white rounded-lg shadow-sm">
            <div class="px-6 py-4 border-b border-gray-200">
                ...
                <p class="text-sm text-gray-600 mt-1">
                    Update the details below to modify the section.
                </p>
            </div>

            <form action="{{ route('sections.update', $section->id) }}" method="POST" class="px-6 py-6 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    >
                        ...
                        @foreach($classes as $class)
                            <option 
                                value="{{ $class->id }}" 
                                {{ old('academic_class_id', $section->academic_class_id) == $class->id ? 'selected' : '' }}
                            >
                    ...
                    <div class="space-y-2">
                        ...
                        <label class="flex items-center">
                            <input 
                                ...
                                name="status" 
                                value="0"
                                {{ old('status', $section->status) == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-2 focus:ring-blue-500"
                            >
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm text-blue-800">
                        <strong>Note:</strong> Fields marked with <span class="text-red-500">*</span> are required. Section code must be unique.
                    </p>
                </div>
            </div>
        </div>
