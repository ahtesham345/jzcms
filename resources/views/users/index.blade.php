    ...
    <div class="bg-white rounded-lg shadow-sm">
                        ...
                        @foreach($users as $user)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                    @can('users.view')
                                        <a href="{{ route('users.show', $user->id) }}" class="text-blue-600 hover:text-blue-800" title="View User">
                                    ...
                                    @endcan
                                    @can('users.edit')
                                        <a href="{{ route('users.edit', $user->id) }}" class="text-yellow-600 hover:text-yellow-800" title="Edit User">
                                            <svg class="w-5 h-5 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @else
            ...
            <div class="px-6 py-12 text-center">
                ...
                @if(request('search') || request('role'))
                    <h3 class="mt-2 text-sm font-medium text-gray-900">No users found matching your search</h3>
