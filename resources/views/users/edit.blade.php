            ...
            <form action="{{ route('users.update', $user->id) }}" method="POST" class="px-6 py-6 space-y-6">
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-medium text-gray-700 mb-2">
                        Confirm Password <span class="text-gray-400">(If changing password)</span>
                    </label>
                    <input 
                        type="password" 
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm text-blue-800">
                        <strong>Note:</strong> Fields marked with <span class="text-red-500">*</span> are required. Leave password fields blank to keep the current password.
                    </p>
                </div>
            </div>
        </div>
